  ...
  return (
    <section className="px-6 py-24 md:px-10 md:py-28 xl:px-16 xl:py-32">
      <motion.div
        ...
        className="w-full border-t border-apriil-line/80 pt-16"
      >
        <motion.div
        ...
        >
          ...
          <p className="max-w-3xl text-lg leading-8 text-apriil-muted md:pl-6">
            Apriil går inn der synlighet, anskaffelse og beslutningsgrunnlag
            trenger tydeligere retning. Hvert engasjement bygges rundt
            kommersiell effekt, arbeidsform og hva ledelsen trenger å forstå
            videre.
          </p>
        </motion.div>
        ...
        <div className="mt-14 grid gap-6 xl:grid-cols-[1.03fr_1.03fr_0.94fr]">
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#d8c6b8]">
              Søkesynlighet
            </p>
            <p className="mt-8 text-4xl font-semibold tracking-[-0.065em] md:text-[3.15rem] md:leading-none">
              Fra NOK 15.000 / måned
            </p>
            <p className="mt-5 max-w-lg text-base leading-8 text-white/74">
              Strategisk og teknisk arbeid for virksomheter som vil bli
              tydeligere der kunder faktisk søker og oppdager leverandører.
            </p>
            ...
            <Link
              ...
              className="mt-10 inline-flex items-center gap-3 rounded-full border border-white/16 bg-white px-5 py-3 text-sm font-semibold text-apriil-dark transition hover:-translate-y-0.5 hover:bg-[#f6f1eb]"
            >
              Se tjeneste
          ...
          >
            ...
            <p className="mt-8 text-4xl font-semibold tracking-[-0.065em] text-apriil-dark md:text-[3.15rem] md:leading-none">
              Fra NOK 15.000 / måned
            </p>
            <p className="mt-5 max-w-lg text-base leading-8 text-apriil-muted">
              Kontinuerlig forbedring av trafikkvalitet, budsjetteffektivitet og
              konverteringsstyrke for virksomheter med tydelige vekstmål.
            </p>
            ...
            <Link
              ...
              className="mt-10 inline-flex items-center gap-3 rounded-full border border-apriil-line/80 bg-white px-5 py-3 text-sm font-semibold text-apriil-dark transition hover:-translate-y-0.5 hover:border-apriil-primary/40 hover:text-apriil-primary"
            >
              Se tjeneste
              <span aria-hidden="true">↗</span>
            </Link>
          ...
          >
            ...
            <h3 className="mt-5 max-w-[11ch] text-3xl font-semibold tracking-[-0.05em] text-apriil-dark">
              Lav friksjon for første beslutning.
            </h3>
            <p className="mt-5 text-base leading-8 text-apriil-muted">
              For team som ønsker et tydelig startpunkt før et løpende
              engasjement, tilbyr Apriil analyser som gjør situasjon, muligheter
              og prioriteringer enklere å vurdere.
            </p>
            <div className="mt-8 space-y-5 border-t border-apriil-line/80 pt-6 text-sm leading-7 text-apriil-muted">
              <div>
                <p className="font-semibold uppercase tracking-[0.18em] text-apriil-dark">
                  Søkesynlighet
                </p>
            ...
            <a
              href="#contact"
              className="mt-10 inline-flex items-center gap-3 text-sm font-semibold text-apriil-dark transition hover:text-apriil-primary"
            >
