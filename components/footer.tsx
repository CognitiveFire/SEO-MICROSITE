    ...
    <footer className="bg-[#151312] px-6 pb-6 pt-12 text-[#f2f0eb] md:px-10 md:pt-16 xl:px-16">
      <div className="w-full">
        <div className="grid gap-10 lg:grid-cols-[1.35fr_0.9fr_0.85fr_0.8fr]">
          <div>
            <p className="text-[34px] font-medium tracking-[0.18em] text-white">
              APRIIL
            </p>
            ...
            >
              Kontakt oss
              <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#ff4e1a] text-white">
                →
              </span>
            </Link>
          </div>
          ...
          <div>
            <h3 className="text-[2.05rem] font-semibold tracking-[-0.02em] text-white">
              Tjenester
            </h3>
            ...
            <Link
              href="/results"
              className="mt-4 inline-block text-[1.9rem] font-semibold tracking-[-0.02em] text-white hover:opacity-80 md:text-[2.05rem]"
            >
              Arbeider
            </Link>
          </div>
