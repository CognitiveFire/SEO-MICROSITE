...
export function ContactSection() {
  return (
    <section
      id="contact"
      className="bg-[#1c1715] px-6 py-24 text-white md:px-10 md:py-28 xl:px-16 xl:py-32"
    >
      <div className="w-full grid gap-14 md:grid-cols-[0.82fr_1.18fr] md:items-start lg:gap-16">
        <div className="pt-2">
          <p className="text-xs font-semibold uppercase tracking-[0.26em] text-[#d8a57f]">
            Kontakt
          </p>
          ...
          <p className="mt-9 max-w-md text-lg leading-8 text-white/70 md:text-[1.04rem]">
            Vi kan gå gjennom tjenestestruktur, operasjonell rapportering,
            prioritering og forholdet mellom search visibility, acquisition og
            Apriil Clarity.
          </p>
        </div>
        <LeadCaptureForm
