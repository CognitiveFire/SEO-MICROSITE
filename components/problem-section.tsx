        ...
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-lg leading-8 text-apriil-muted">
              Når SEO, betalt anskaffelse og analyse beskrives som separate
              systemer, svekkes strategien. Team optimaliserer kanaler, mens
              ledelsen fortsatt mangler et samlet operativt bilde.
            </p>
          </div>
          <div className="grid gap-px overflow-hidden rounded-[20px] border border-apriil-line/80 bg-apriil-line/80 md:grid-cols-3">
            <div className="bg-[#fbfaf7] p-6">
              ...
              <p className="mt-4 text-sm leading-7 text-apriil-muted">
                Separate dashbord gjentar de samme målingene med ulikt språk,
                men uten et felles beslutningsrammeverk.
              </p>
            </div>
            <div className="bg-[#fbfaf7] p-6">
              <h3 className="text-xl font-semibold tracking-[-0.03em] text-apriil-dark">
              ...
              <p className="mt-4 text-sm leading-7 text-apriil-muted">
                SEO- og paid-team handler på isolerte signaler, selv når de
                påvirker den samme etterspørselen og de samme
                landingssideutfallene.
              </p>
            </div>
            <div className="bg-[#fbfaf7] p-6">
              <h3 className="text-xl font-semibold tracking-[-0.03em] text-apriil-dark">
              ...
              <p className="mt-4 text-sm leading-7 text-apriil-muted">
                Flere dashbord forbedrer sjelden beslutninger. En sterkere
                arbeidsmodell gjør det.
              </p>
            </div>
          </div>
        </div>
