...
export function HeroSection() {
  return (
    <section className="px-6 md:px-10 xl:px-16">
      <div className="w-full grid gap-12 py-16 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:py-20">
        <div>
          ...
          <p className="mt-8 max-w-3xl text-[20px] leading-[1.6] text-apriil-muted md:text-[22px]">
            ...
            med mål om tydeligere beslutninger og sterkere kommersiell
            utvikling.
          </p>
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <a
              href="#services"
              className="text-sm font-semibold text-apriil-dark transition hover:text-apriil-primary"
            >
              Se tjenester
            </a>
          </div>
              ...
              <div className="rounded-[28px] bg-[#111214] p-3">
                <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-black">
                  ...
                  <div className="aspect-[4/3] w-full bg-[linear-gradient(145deg,#141517_0%,#1b1d20_45%,#151618_100%)] p-5 md:p-6">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#d8c6b8]">
                      Apriil Clarity
                    </p>

                    <div className="mt-4 grid grid-cols-3 gap-2.5">
                      <div className="rounded-lg border border-white/20 bg-white/10 px-2 py-2 text-xs font-medium text-white/90">
                        Synlighet
                      </div>
                      <div className="rounded-lg border border-white/20 bg-white/10 px-2 py-2 text-xs font-medium text-white/90">
                        Anskaffelse
                    ...
                    <div className="mt-4 rounded-xl border border-white/20 bg-[linear-gradient(180deg,rgba(255,255,255,0.14),rgba(255,255,255,0.06))] p-3">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-[11px] font-semibold uppercase tracking-[0.17em] text-white/80">
                          Intelligensprinsipper
                        </p>
                      </div>
                      <p className="mt-2 text-sm font-semibold leading-5 text-white">
                        Tolkning, prioritering og tydelige operative valg
                      </p>
                    </div>

                    <div className="mt-4 grid grid-cols-2 gap-2.5">
                      <div className="rounded-lg border border-white/20 bg-white/10 px-2 py-2 text-xs text-white/90">
                        Bedre beslutningsgrunnlag
                      </div>
                      <div className="rounded-lg border border-white/20 bg-white/10 px-2 py-2 text-xs text-white/90">
                        Sterkere kommersiell effekt
                      </div>
                    </div>
                  </div>
                </div>
