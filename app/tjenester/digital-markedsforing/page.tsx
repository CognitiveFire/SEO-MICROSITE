...
const serviceCards = [
  {
    ...
    body: "Vi optimaliserer annonseinvesteringer på tvers av sosiale medier, søkeord, display og video. Strategien handler om intelligente prioriteringer og målbar effekt.",
    href: "/tjenester/digital-markedsforing/betalt-media",
    icon: "social" as const,
  },
  {
    title: "SEO - søkemotoroptimalisering",
    body: "Vi gjør nettsiden din enkel å finne og elsket av Google. SEO handler om hvordan alle aspekter av nettsiden din gjør den attraktiv for søkemotorene å rangere høyt i resultatlistene.",
    href: "/tjenester/digital-markedsforing/seo",
    icon: "seo" as const,
  },
  {
    title: "Sporing og analyse",
    body: "I digital markedsføring er alt sporbart, målbart og kvantifiserbart. Det gjør at vi i sanntid kan analysere kunders aktivitet gjennom dine digitale kanaler og kampanjer.",
    href: "/tjenester/digital-markedsforing/analyse",
    icon: "display" as const,
  },
  {
    title: "Programmatic",
    body: "Vi bruker programmatisk kjøp for presis distribusjon i riktig kanal, til riktig tid og med tydelig styring av kostnad og effekt.",
    href: "/tjenester/digital-markedsforing/programmatic",
    icon: "video" as const,
  },
  {
    title: "Podcast",
    body: "Vi hjelper virksomheter med å finne og sponse relevante podcaster der målgruppen bruker tid. Fokus på relevant målgruppe og målbar effekt.",
    href: "/tjenester/digital-markedsforing/podcast",
    icon: "social" as const,
  },
  {
    title: "Digital TV-annonsering",
    body: "Vi bygger tilstedeværelse i streaming-TV og connected TV-kanaler der målgruppen bruker stadig mer tid på underholdning og nyheter.",
    href: "/tjenester/digital-markedsforing/digital-tv-ads",
    icon: "video" as const,
  },
  {
    title: "Ute av hjemmet",
    body: "Programmatisk utendørsreklame - PHOOH - har hatt en eksplosiv vekst de siste par årene. Digitale skjermer i bybildet har blitt tilgjengeliggjort for programmatiske kjøp.",
