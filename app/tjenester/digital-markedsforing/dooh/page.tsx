...
export const metadata: Metadata = {
  ...
  description: "DOOH-radgivning fra Apriil med tydelig prioritering av flater, timing og kommersiell effekt.",
};
  ...
  return (
    <ChannelServicePage
      ...
      caseStudy={{
        ...
        challenge: "Mangel pa sammenheng mellom flatevalg og kommersielle prioriteringer.",
        actions: "Bygget ny DOOH-plan med geografisk prioritering og felles evalueringsramme.",
        result: "Mer presis lokal synlighet og bedre styring av investeringene.",
      }}
    />
  );
}
