    ...
    <main>
      <section className="px-6 py-20 md:px-10 xl:px-16">
        <div className="mx-auto grid max-w-6xl gap-10 border-t border-apriil-line/70 pt-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-apriil-muted">Analyse</p>
            ...
            <p className="mt-7 max-w-3xl text-base leading-8 text-apriil-muted md:text-lg">
              Vi rydder i signalgrunnlaget og bygger en modell som gjor prioriteringer enklere.
            </p>
            <HeroActions />
          </div>
          <SignalFlowVisual />
          ...
          steps={[
            {
              label: "Steg 1",
              title: "Kartlegging",
              points: ["Datakilder", "Kundereiser", "Malestruktur", "Signalkvalitet"],
            },
            {
              label: "Steg 2",
              title: "Validering",
              points: ["Attribusjon", "Tracking", "Konsistens", "Beslutningsgrunnlag"],
            },
            {
              label: "Steg 3",
              title: "Prioritering",
              points: ["Tiltaksrekkefolge", "Kanalanbefaling", "Investeringsretning", "Ansvar"],
            },
            {
              label: "Steg 4",
              title: "Styring",
              points: ["Lopende review", "Rapportering", "Strategiske justeringer"],
            },
          ]}
        />
      </SectionContainer>
          ...
          studies={[
            {
              ...
              situation: "Rapportering fra flere systemer uten felles konklusjon.",
              challenge: "Lav tillit til datagrunnlaget i budsjettbeslutninger.",
              actions: "Bygget felles signalmodell og tydelig valideringsprosess.",
              result: "Hoyere trygghet i prioriteringer og mer presis allokering av investeringer.",
            },
            {
              title: "Regional handelskjede",
              situation: "Store regionale avvik i kanalresultater.",
              challenge: "Mangler i beslutningsgrunnlaget for riktig mediemiks.",
            ...
            },
            {
              ...
              situation: "Høy aktivitet, men svak sammenheng mellom innsats og effekt.",
              challenge: "Manglende modell for prioritering pa tvers av team.",
              actions: "Definerte styringsmodell og tydelige beslutningspunkter.",
              result: "Raskere og tryggere prioriteringer i kommersielle tiltak.",
            },
          ]}
        />
      </SectionContainer>
          ...
          tiers={[
            {
              ...
              audience: "For virksomheter som trenger tydeligere rapportering og tryggere grunnlag.",
              focus: [
            ...
            },
            {
              ...
              audience: "For virksomheter som trenger lopende analyse pa tvers av kanaler.",
              focus: [
            ...
            },
            {
              ...
              audience: "For storre organisasjoner med hoy kompleksitet og behov for lederforankret styring.",
              focus: [
      ...
      <SectionContainer title="God markedsforing starter med a forsta hva som faktisk virker.">
        <div className="rounded-[14px] border border-apriil-line/80 bg-[#f8f7f4] p-7 md:flex md:items-center md:justify-between md:gap-8">
          <p className="max-w-2xl text-base leading-8 text-apriil-muted md:text-lg">
            Vi kan gi en konkret vurdering av dagens signalgrunnlag og neste riktige prioritering.
          </p>
          <Link
            href="/contact"
