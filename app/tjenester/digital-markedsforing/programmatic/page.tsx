...
export const metadata: Metadata = {
  ...
  description: "Programmatic-radgivning fra Apriil med kontroll pa rekkevidde, frekvens og kommersiell kvalitet.",
};
  ...
  return (
    <ChannelServicePage
      ...
      caseStudy={{
        ...
        situation: "Stor mediespredning uten tydelig sammenheng mellom eksponering og ettersporsel.",
        challenge: "For svak prioritering av marked, frekvens og kanalrolle.",
        actions: "Etablerte ny programmatisk plan med tydelig segmentering og styringspunkter.",
        result: "Mer presis distribusjon og bedre kommersiell kontroll pa investeringene.",
      }}
    />
  );
}
