        ...
        <div className="mt-6 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-apriil-muted md:text-xl">
              Apriil Clarity er intelligenslaget som samler fragmenterte input,
          ...
          <div className="border border-apriil-line/80 bg-apriil-dark p-6 text-white">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#d8c6b8]">
              Hva det gjør
            </p>
            <ul className="mt-4 space-y-3 text-sm leading-7 text-white/72">
              <li>
                Samler signaler fra søkesynlighet, betalt anskaffelse og
                rapportering
              </li>
              <li>
                Vekter påvirkning, kompleksitet, hast og risiko før prioritering
              </li>
              <li>
                Gjør output om til tiltak, eierskap og kommersielle
                implikasjoner
              </li>
            </ul>
          </div>
      ...
      <section className="w-full mt-16 border-t border-apriil-line/80 pt-16">
        <div className="grid gap-px overflow-hidden border border-apriil-line/80 bg-apriil-line/80 lg:grid-cols-3">
          <div className="bg-[#fbfaf7] p-8">
            ...
            <h2 className="mt-4 text-2xl font-semibold tracking-[-0.04em] text-apriil-dark">
              Etterspørsel, anskaffelse, landingssideatferd og
              rapporteringshelse.
            </h2>
            <p className="mt-4 text-sm leading-7 text-apriil-muted">
              Clarity henter ikke bare tall. Den organiserer hvilket operativt
              bilde som faktisk er relevant for neste beslutning.
            </p>
          </div>
          <div className="bg-[#fbfaf7] p-8">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-apriil-primary">
            ...
            <h2 className="mt-4 text-2xl font-semibold tracking-[-0.04em] text-apriil-dark">
              En prioriteringsmodell i stedet for enda et dashbord.
            </h2>
            <p className="mt-4 text-sm leading-7 text-apriil-muted">
              Påvirkning, gjennomførbarhet, sikkerhet og tverrkanal-effekt
              vurderes samlet før et tiltak får oppmerksomhet.
            </p>
          </div>
          <div className="bg-[#fbfaf7] p-8">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-apriil-primary">
            ...
            <h2 className="mt-4 text-2xl font-semibold tracking-[-0.04em] text-apriil-dark">
              En tydeligere operativ sekvens for både spesialister og ledelse.
            </h2>
            <p className="mt-4 text-sm leading-7 text-apriil-muted">
              Team får tydeligere prioriteringer. Ledelsen får et sterkere
              beslutningsgrunnlag. Begge ser hva som skal skje videre og
              hvorfor.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-[1fr_1fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em] text-apriil-dark">
              Et intelligenslag som gjør neste prioritering tydelig.
            </h2>
          </div>
          <div className="border border-apriil-line/80 bg-[#fbfaf7] p-6 md:p-8">
            <p className="text-base leading-8 text-apriil-muted">
              Clarity er laget for virksomheter som trenger ett felles
              beslutningsgrunnlag på tvers av spesialister, ledelse og
              kommersielle mål. Det reduserer rapporteringsstøy og gjør
              oppfølgingen mer operativ.
            </p>
          </div>
        </div>
      </section>
